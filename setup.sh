...
sudo apt -o Apt::Get::Assume-Yes=true install cmake deluge ffmpeg g++ gcc gimp git krita libcurl4-openssl-dev libfontconfig1-dev libgl1-mesa-dev libglew-dev libsdl2-dev libsdl2-image-dev libsdl2-mixer-dev libsdl2-ttf-dev libvulcan-dev libxml2-dev libxslt1-dev make mesa-vulkan-drivers obs-studio python3-dev python3-pip retroarch vlc vulkan-tools wget zlib1g-dev
